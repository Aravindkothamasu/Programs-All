...
void ReadMe(void)
{
	...
	Red Black Treee Implementation :\n\t--------------------------------------\n\t\t. Implementation of RB tree ,creating\
	a tree contains numericals ,in a sorted array format.\n\t\t. You can just run the executable file, with necessary opt\
	ions.\n\t\t. if need help to figure ,how to run just type [./a.out ] [--help], It displays the help message.\n\t\t. T\
	o generate executablefile,run Makefile ie., $make.\n\t\t. To develop,all the code it takes around 15days(challa kasth\
	apadda).\n\t\t. To develop,all the code it takes around 15days(challa kasthapadda).\n\t\t. Files need to compile\
	:\n\t\t\t\t. creation.c	--\\\n\t\t\t\t. deletion.c	----\\__________	vietiannitiki \"rb_header.h\" kavall\
